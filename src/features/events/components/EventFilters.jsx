      ...
      <div className="grid grid-cols-1 gap-3 sm:gap-4 lg:grid-cols-6 lg:gap-4 items-start">
        <div className="lg:col-span-3 relative group">
          <input
            ...
            onFocus={() =>
              setShowSuggestions(
                searchQuery.length > 2 && filteredEvents.length > 0
              )
            }
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 bg-linear-to-r from-purple-500 to-purple-400 rounded-2xl text-sm font-semibold hover:from-purple-600 hover:to-purple-500 shadow-md hover:shadow-lg "
          >
            Clear All
          </button>
        </div>
